...
describe LearningPeriod do
  ...
  context 'when other learning periods were created' do
    ...
    it 'should not intersect with any other learning periods that in the same course learning' do
      subject.course_learning = @another_learning_period.course_learning.reload
    ...
    it 'can intersect with other learning periods that not in the same course learning' do
      subject.start_on = @another_learning_period.start_on + 1.day
      subject.end_on = subject.start_on + 29.days
